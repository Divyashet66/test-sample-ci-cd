pipeline {
  agent any
	...
	environment {
				...
				CLUSTER_NAME = "gke-prod-gke-as1"
				LOCATION = "asia-south1-a"
				CREDENTIALS_ID = "inframod-nw18-host-poc"			
	}
	    ...
	    stage('Build Docker Image') {
		    steps {
				...
				sh 'sudo add-apt-repository ppa:cncf-buildpacks/pack-cli'
			      ...
			      sh 'pack build network18-nodejs --builder paketobuildpacks/builder:full'
				sh 'docker tag network18-nodejs gcr.io/inframod-nw18-host-poc/network18-nodejs'
		    ...
		    steps {
			    script {
				    echo "Push Docker Image"
				        ...
				        sh "sudo docker push gcr.io/inframod-nw18-host-poc/network18-nodejs"
