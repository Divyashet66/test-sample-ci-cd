	    ...
	    stage('Build Docker Image') {
		    steps {
				...
				sh 'sudo add-apt-repository ppa:cncf-buildpacks/pack-cli'
			      ...
			      sh 'pack build node-private --builder gcr.io/buildpacks/builder:google-22'
				sh 'docker tag node-private us-central1-docker.pkg.dev/tech-rnd-project/network18/node-private'
		    ...
		    steps {
			    script {
				    echo "Push Docker Image"
				        ...
				        sh "sudo docker push us-central1-docker.pkg.dev/tech-rnd-project/network18/node-private"
