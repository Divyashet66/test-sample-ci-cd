	    ...
	    stage('Build Docker Image') {
		    steps {
				...
				sh 'sudo add-apt-repository ppa:cncf-buildpacks/pack-cli'
			      ...
			      sh 'pack build node-js-network18 --builder paketobuildpacks/builder:full'
				sh 'docker tag node-js-network18 gcr.io/inframod-nw18-svc-cnt-poc/node-js-network18'
		    ...
		    steps {
			    script {
				    echo "Push Docker Image"
				        ...
				        sh "sudo docker push gcr.io/inframod-nw18-svc-cnt-poc/node-js-network18"
